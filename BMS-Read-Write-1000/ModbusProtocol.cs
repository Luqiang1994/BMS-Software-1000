namespace BMS_Read_Write_1000
{
    public static class BmsRegisters
    {
        ...
        public const ushort BmsWarningWord1 = 0x003b;
        public const ushort BmsWarningWord2 = 0x003c;
        public const ushort BalancedWord1 = 0x003d;
        public const ushort BalancedWord2 = 0x003e;
        public const ushort DischargeMosState = 0x003f;
        public const ushort ChargeMosState = 0x0040;
        public const ushort BatteryType = 0x0041;

        public const ushort OverVoltageProtectValue = 0x0042;
        public const ushort OverVoltageProtectDelay = 0x0043;
        public const ushort OverVoltageRestoreValue = 0x0044;
        public const ushort UnderVoltageProtectValue = 0x0045;
        public const ushort UnderVoltageProtectDelay = 0x0046;
        public const ushort UnderVoltageRestoreValue = 0x0047;
        public const ushort BalanceStartVoltage = 0x0048;
        public const ushort BalanceStartPressureDiff = 0x0049;
        public const ushort DischargeOvercurrentL1 = 0x004a;
        public const ushort DischargeOvercurrentL1Delay = 0x004b;
        public const ushort DischargeOvercurrentL2 = 0x004c;
        public const ushort DischargeOvercurrentL2Delay = 0x004d;
        public const ushort ChargeOvercurrentValue = 0x004e;
        public const ushort ChargeOvercurrentDelay = 0x004f;
        public const ushort DischargeOvertempProtect = 0x0050;
        public const ushort DischargeOvertempRestore = 0x0051;
        public const ushort DischargeUndertempProtect = 0x0052;
        public const ushort DischargeUndertempRestore = 0x0053;
        public const ushort ChargeOvertempProtect = 0x0054;
        public const ushort ChargeOvertempRestore = 0x0055;
        public const ushort ChargeUndertempProtect = 0x0056;
        public const ushort ChargeUndertempRestore = 0x0057;
        public const ushort RemainingCapacityHigh = 0x0058;
        public const ushort RemainingCapacityLow = 0x0059;
        public const ushort FunctionParameterSet = 0x005a;
        public const ushort SelfConsumptionPower = 0x005b;
        public const ushort SleepLeakageCurrent = 0x005c;
        public const ushort Afe2BatteryStrings = 0x005d;
        public const ushort MosOvertempProtect = 0x005e;
        public const ushort MosOvertempRestore = 0x005f;

        public const ushort ChargeOnDischargeOff = 0x0060;
        public const ushort ChargeOffDischargeOn = 0x0061;
        public const ushort ChargeOnDischargeOn = 0x0062;
        public const ushort ChargeOffDischargeOff = 0x0063;
        public const ushort ExitManualMode = 0x0064;
        public const ushort CurrentZeroing = 0x0065;
        public const ushort ChargingCorrection = 0x0066;
        public const ushort DischargingCorrection = 0x0067;
        public const ushort RestoreFactoryDefault = 0x0068;
        public const ushort HardwareVersion = 0x0069;
        public const ushort TotalNtcCount = 0x006a;
    }
